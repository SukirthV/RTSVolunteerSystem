...
namespace RTSVolunteerSystem.Pages.Register
{
    public class IndexModel : PageModel
    {
        ...
        public void OnPost()
        {
            ...
            if (volunteerInfo.fullname.Length == 0 || volunteerInfo.email.Length == 0 || volunteerInfo.password.Length == 0 ||
                volunteerInfo.phone.Length == 0 || volunteerInfo.address.Length == 0 ||
                volunteerInfo.ecname.Length == 0 || volunteerInfo.ecphone.Length == 0 ||
                volunteerInfo.dob.Length == 0 || volunteerInfo.availablefrom.Length == 0 ||
                volunteerInfo.availableto.Length == 0 || volunteerInfo.comments.Length == 0)
            {
                errorMessage = "All the fields are required";
                return;
            }
            //save new volunteer into batabase
            try
            {
