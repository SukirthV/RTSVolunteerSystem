...
namespace RTSVolunteerSystem.Pages.Teams
{
    public class EditModel : PageModel
    {
        ...
        public void OnPost()
        {
            ...
            if (teamInfo.id.Length == 0 || teamInfo.teamname.Length == 0 || teamInfo.contactname.Length == 0 ||
                teamInfo.contactemail.Length == 0 || teamInfo.contactphone.Length == 0 || teamInfo.description.Length == 0)
            {
